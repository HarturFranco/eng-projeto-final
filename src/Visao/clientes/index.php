    ...
    <div>
      ...
      <table>
        ...
        <tbody>
          ...
          ?>
            <tr string="<?php echo "{$cli["cliCodigo"]} {$cli["cliNome"]}" ?>">
              <td><?php echo $cli["cliCodigo"] ?></td>
              <td><?php echo $cli["cliNome"] ?></td>
              <td><?php echo $cli["cliCPF"] ?></td>
              <td>
                <a href="clientes/editar/<?php echo $cli["cliCodigo"]; ?>">
                ...
                <form class="icon" action="Controle/Controle" method="POST">
                  <input type="text" name="cliCodigo" value="<?php echo $cli["cliCodigo"] ?>" hidden>
