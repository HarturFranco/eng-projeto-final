...
$categoria = new CategoriaControle();
    ...
    <div>
      ...
      <table>
        ...
        <tbody>
          ...
          ?>
            <tr string="<?php echo "{$cat["catCodigo"]} {$cat["catNome"]}" ?>">
              <td><?php echo $cat["catCodigo"] ?></td>
              <td><?php echo $cat["catNome"] ?></td>
              <td><?php echo $cat["catDescricao"] ?></td>
              <td>
                <a href="categorias/editar/<?php echo $cat["catCodigo"]; ?>">
                ...
                <form class="icon" action="Controle/Controle" method="POST">
                  <input type="text" name="cCodigo" value="<?php echo $cat["catCodigo"] ?>" hidden>
