      ...
      <table>
        ...
        <tbody>
          <?php
                ...
                ?>
            <tr string="<?php echo "{$fun["proCodigo"]} {$fun["proNome"]}" ?>">
              <td><?php echo $fun["proCodigo"] ?></td>
              <td><?php echo $fun["proNome"] ?></td>
              <td><?php echo $fun["proPreco"] ?></td>
              <td><?php echo $fun["proQtdEstoque"] ?></td>
              <td><?php echo $fun["proDataCadastro"] ?></td>
              <td><?php echo $fun["Categoria_catCodigo"]?></td>
              <td>
                <a href="produtos/editar/<?php echo $fun["proCodigo"]; ?>">
                ...
                <form class="icon" action="Controle/Controle" method="POST">
                  <input type="text" name="pCodigo" value="<?php echo $fun["proCodigo"] ?>" hidden>
