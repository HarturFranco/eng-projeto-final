...
$proControle = new ProdutoControle();
$dados = $proControle->index();
?>
      ...
      <table>
        ...
        <tbody>
          <?php
                ...
                ?>
            <tr string="<?php echo "{$pro["proCodigo"]} {$pro["proNome"]}" ?>">
              <td><?php echo $pro["proCodigo"] ?></td>
              <td><?php echo $pro["proNome"] ?></td>
              <td><?php echo $pro["proPreco"] ?></td>
              <td><?php echo $pro["proQtdEstoque"] ?></td>
              <td><?php echo $pro["proDataCadastro"] ?></td>
              <td><?php echo $pro['Categoria_catCodigo']->getNome()?></td>
              <td>
                <a href="produtos/editar/<?php echo $pro["proCodigo"]; ?>">
                ...
                <form class="icon" action="Controle/Controle" method="POST">
                  <input type="text" name="pCodigo" value="<?php echo $pro["proCodigo"] ?>" hidden>
